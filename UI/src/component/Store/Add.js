...
class StoreAdd extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if(type === CommonConstant.ADDEDITSTORESUCCESS){
            this.props.alertNotification('Store Created Successfuly !','success');
                            ...
                            <div className="box box-primary">
                                ...
                                <div className="box-body">
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" id="storeName" name="storeName" onChange={this.inputChanges} autoComplete="off"/>
                                        {
                                            (submit && !storeName) &&
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" id="phone" name="phone" onChange={this.inputChanges}/>
                                        {
                                            (submit && !phone) &&
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" id="email" name="email" onChange={this.inputChanges}/>
                                        {
                                            (submit && emailError) &&
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" id="address" name="address" onChange={this.inputChanges}/>
                                        {
                                            (submit && !address) &&
